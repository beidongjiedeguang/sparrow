...
goog.exportSymbol('proto.sparray.DocProto.ContentCase', null, global);
/**
...
proto.sparray.DocProto = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, proto.sparray.DocProto.oneofGroups_);
};
 ...
 * @const
 */
proto.sparray.DocProto.oneofGroups_ = [[2,3,4]];

/**
 * @enum {number}
 */
proto.sparray.DocProto.ContentCase = {
  CONTENT_NOT_SET: 0,
  BLOB: 2,
  TENSOR: 3,
  TEXT: 4
...
/**
 * @return {proto.sparray.DocProto.ContentCase}
 */
proto.sparray.DocProto.prototype.getContentCase = function() {
  return /** @type {proto.sparray.DocProto.ContentCase} */(jspb.Message.computeOneofCase(this, proto.sparray.DocProto.oneofGroups_[0]));
};
...
proto.sparray.DocProto.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    tensor: (f = msg.getTensor()) && proto.sparray.DenseNdArrayProto.toObject(includeInstance, f),
...
proto.sparray.DocProto.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 2:
      ...
      break;
    case 3:
      var value = new proto.sparray.DenseNdArrayProto;
      reader.readMessage(value,proto.sparray.DenseNdArrayProto.deserializeBinaryFromReader);
      msg.setTensor(value);
      break;
    case 4:
      var value = /** @type {string} */ (reader.readString());
...
proto.sparray.DocProto.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      3,
      f,
      proto.sparray.DenseNdArrayProto.serializeBinaryToWriter
    );
  }
...
proto.sparray.DocProto.prototype.setBlob = function(value) {
  return jspb.Message.setOneofField(this, 2, proto.sparray.DocProto.oneofGroups_[0], value);
};
 ...
 * @return {!proto.sparray.DocProto} returns this
 */
proto.sparray.DocProto.prototype.clearBlob = function() {
  return jspb.Message.setOneofField(this, 2, proto.sparray.DocProto.oneofGroups_[0], undefined);
};
 ...
 * @return {boolean}
 */
proto.sparray.DocProto.prototype.hasBlob = function() {
  return jspb.Message.getField(this, 2) != null;
};


/**
 * optional DenseNdArrayProto tensor = 3;
 * @return {?proto.sparray.DenseNdArrayProto}
 */
proto.sparray.DocProto.prototype.getTensor = function() {
  return /** @type{?proto.sparray.DenseNdArrayProto} */ (
    jspb.Message.getWrapperField(this, proto.sparray.DenseNdArrayProto, 3));
};


/**
 * @param {?proto.sparray.DenseNdArrayProto|undefined} value
 * @return {!proto.sparray.DocProto} returns this
*/
proto.sparray.DocProto.prototype.setTensor = function(value) {
  return jspb.Message.setOneofWrapperField(this, 3, proto.sparray.DocProto.oneofGroups_[0], value);
};
 ...
 * @return {!proto.sparray.DocProto} returns this
 */
proto.sparray.DocProto.prototype.clearTensor = function() {
 ...
 * @return {boolean}
 */
proto.sparray.DocProto.prototype.hasTensor = function() {
...
proto.sparray.DocProto.prototype.setText = function(value) {
  return jspb.Message.setOneofField(this, 4, proto.sparray.DocProto.oneofGroups_[0], value);
};
 ...
 * @return {!proto.sparray.DocProto} returns this
 */
proto.sparray.DocProto.prototype.clearText = function() {
  return jspb.Message.setOneofField(this, 4, proto.sparray.DocProto.oneofGroups_[0], undefined);
};
 ...
 * @return {boolean}
 */
proto.sparray.DocProto.prototype.hasText = function() {
